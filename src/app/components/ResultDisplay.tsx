...
export default function ResultDisplay({ data, onScanAgain }: { data: ProductInfo; onScanAgain: () => void; }) {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 pt-20">
      <div className="w-full max-w-lg mx-auto bg-slate-950 backdrop-blur-xl border border-emerald-400/20 rounded-2xl shadow-2xl shadow-emerald-900/50 overflow-hidden animate-fade-in">
